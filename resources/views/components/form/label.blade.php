<label {{ $attributes(['class' => 'form-label inline-block mb-2 text-gray-700']) }}>
    {{ $slot }}
</label>
...
{{-- <form action="" >
  ...
  <form>
    ...
    <button type="submit" class="px-6 py-2.5  bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0
